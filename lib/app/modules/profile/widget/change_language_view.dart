import 'package:ariyanrestaurant/app/modules/splash/controllers/splash_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          backgroundColor: AppColor.primaryBackgroundColor,
          leading: IconButton(
            icon: SvgPicture.asset(Images.back,color: AppColor.primaryColor,height: 25,),
            onPressed: () {
              Get.back();
            },
          ),
